    ...
    <div class="side-by-side-layout">
        ...
        <div class="form-section">
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-xl font-semibold mb-4">
                    {{ $editingRecordId ? 'Edit Partner' : 'Add New Partner' }}
                </h2>
                ...
                <x-filament-panels::form wire:submit="save">
                    ...
                    <div class="flex justify-end mt-4">
                        <x-filament::button type="submit" class="bg-primary-600 hover:bg-primary-700">
                            {{ $editingRecordId ? 'Update Partner' : 'Save Partner' }}
                        </x-filament::button>
                    </div>
        ...
        <div class="data-section">
            <div class="bg-white rounded-lg shadow p-6 h-[600px] flex flex-col">
                <h2 class="text-xl font-semibold mb-4">Existing Partners</h2>
                        ...
                        @foreach($records as $record)
                            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                @if($record->company_logo)
                                    <img src="{{ $this->getImageUrl($record->company_logo) }}" 
                                         alt="Partner Logo" 
