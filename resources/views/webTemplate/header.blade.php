...
<head>
    ...
    height: auto;              /* ✅ content ke hisaab se height */
    min-height: auto;          /* ✅ koi minimum force na ho */
    padding: 30px 0;
    position: relative;
    max-width: 100%;
    transition: all 0.3s ease;
    ...
    justify-content: flex-start;  /* ✅ space-between ki jagah */
}
...
<body>
    ...
    <nav class="header-container" id="headerContainer" role="navigation">
        ...
        @if($aboutExists)
            <a href="{{ $username ? url($username . '/about-us') : '#' }}" class="menu-item" data-page="about" tabindex="0">
                <div class="icon">
        ...
        @if ($projectsExists)
            ...
            <a href="{{ $username ? url($username . '/projects') : '#' }}" class="menu-item" data-page="projects"
                tabindex="0">
                <div class="icon">
        ...
        @if ($servicesExists)
            ...
            <a href="{{ url($user->username . '/services') }}" class="menu-item" data-page="services" tabindex="0">
                <div class="icon">
        ...
        @if ($visionaryExists)
            ...
            <a href="{{ url($user->username . '/visionary') }}" class="menu-item" data-page="visionary" tabindex="0">
                <div class="icon">
        ...
        @if ($mediaExists)
            ...
            <a href="{{ url($user->username . '/media') }}" class="menu-item" data-page="media" tabindex="0">
                <div class="icon">
        ...
        @if ($bankExists)
            ...
            <a href="{{ url($user->username . '/bank-detail') }}" class="menu-item" data-page="bank" tabindex="0">
                <div class="icon">
        ...
        @endif
            ...
            <a href="{{ url($user->username . '/contact') }}" class="menu-item" data-page="contact" tabindex="0">
                <div class="icon">
    ...
    <script>
        ...
        // Blade variables ko JS me pass karo
        const details = {
            name: "{{ $user->name ?? '' }}",
...
END:VCARD`;
            ...
            a.href = url;
            a.download = `${details.name.replace(/\s+/g, '_').toLowerCase() || 'contact'}.vcf`;
        ...
        function setActiveMenuItem() {
            ...
            // Determine which menu item should be active based on current URL
            let activePage = 'about'; // default

            if (currentPath.includes('/projects') || currentPath.includes('projects')) {
                activePage = 'projects';
            } else if (currentPath.includes('/services') || currentPath.includes('services')) {
                activePage = 'services';
            } else if (currentPath.includes('/visionary') || currentPath.includes('visionary')) {
                activePage = 'visionary';
            } else if (currentPath.includes('/media') || currentPath.includes('media')) {
                activePage = 'media';
            } else if (currentPath.includes('/bank') || currentPath.includes('bank')) {
                activePage = 'bank';
            } else if (currentPath.includes('/contact') || currentPath.includes('contact')) {
                activePage = 'contact';
            } else if (currentPath.includes('/download') || currentPath.includes('download')) {
                activePage = 'download';
            } else if (currentPath.includes('/share') || currentPath.includes('share')) {
                activePage = 'share';
            }
        ...
        // Share popup toggle functionality
        ...
        // Click event handling for menu items
        menuItems.forEach(item => {
        ...
        function handleResize() {
            if (window.innerWidth > 1024 && headerContainer.classList.contains('active')) {
                toggleMobileMenu();
            }
        }
        ...
        try {
            ...
            // Passive event listener not supported
        }
    </script>
</body>
